...
public class consult_devis extends javax.swing.JFrame {

    connect cnx = new connect();
    Statement st;
    public consult_devis() {
        initComponents();
        affiche_clients();
    ...
    void affiche_devis(){
        try{
           ...
           st=cnx.obtenircon().createStatement();
           ResultSet rs = st.executeQuery("select * from devis where idclients ='"+Integer.parseInt(num_client.getText())+"'");
           while(rs.next()){
    ...
    try{
        st=cnx.obtenircon().createStatement();
        ResultSet rs = st.executeQuery("select sum(prix_tot) from devis where idclients ='"+Integer.parseInt(num_client.getText())+"'");
        if (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consult_devis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consult_devis().setVisible(true);
            }
        });
    }
